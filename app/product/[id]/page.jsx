              ...
              {productData.image.map((image, index) => (
                <SwiperSlide key={index}>
                  <div
                   ...
                   className="overflow-hidden rounded-xl p-2 bg-[#E0F2E0]" // 🌿 light green background
    >
                    ...
                    <Image
                      ...
                      width={1280}
                      height={720}
                      className="w-full h-auto object-cover transition-transform duration-300 mix-blend-multiply"
                      style={zoomStyle}
                    />
                  </div>
                </SwiperSlide>
